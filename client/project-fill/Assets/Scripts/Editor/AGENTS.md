...
| `UIEditorSetup.CreateWeeklyMissionPopup()` | method | [MenuItem ".../WeeklyMissionPopup"] Weekly Mission Event popup: title/days-left/EP gauge (bg+left-anchored fill)/track summary/mission container (VLG, rows built at runtime)/claim CTA |

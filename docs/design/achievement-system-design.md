...
| `skl_04` | 위클리 퍼스트 | Weekly 랭킹 주간 1위 달성 | Platinum | 600 골드 + **Signal Champion Board Skin** |
...
| `ded_03` | 주간 미션 완주 | 주간 미션 이벤트 1주 완주(트랙 1,200 EP) | Silver | 300 골드 + Shuffle ×5 |
| `ded_04` | 미션 마스터 | 주간 미션 이벤트 누적 4주 완주 | Gold | 800 골드 |
| `ded_05` | 셔플 없는 일주일 | 7일간 Shuffle 부스터 미사용 | Silver | 200 골드 |
| `ded_06` | 100일 플레이어 | 앱 총 접속 100일 (연속 불필요) | Platinum | 1,000 골드 + **Veteran Board Skin** |
...
| `col_05` | 풀 컬렉터 | 모든 코스메틱 잠금 해제 | Platinum | 1,500 골드 + **Collector Board Skin** |
...
| 주간 미션 이벤트 완주 | `ded_03`, `ded_04` |
| Weekly 랭킹 주간 확정 | `skl_04` |

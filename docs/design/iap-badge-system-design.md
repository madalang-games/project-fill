...
- **적용 콘텐츠 (예시)**:
  - **출석부(Attendance/Daily Login)**: 매일 로그인 보상 팝업 링크.
...
| **starter_pack** | 스타터 팩 (`shop.iap.starter.title`) | 1,000 골드 + 부스터 아이템 4종 각 1개 + 광고 제거 혜택 | $4.99 | 소모성 + 비소모성 복합 |
| **master_bundle** | 마스터 번들 (`shop.iap.master.title`) | 5,000 골드 + 부스터 아이템 4종 각 5개 | $9.99 | 소모성 (Consumable) |
